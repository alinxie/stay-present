...
app.layout = html.Div([
        ...
        html.Div([
            dcc.Graph(
                ...
                figure={
                    ...
                    'layout': {
                        'title': 'Data received for each application'
                    }
                }
            )
        ],
        ...
        html.Div([
            dcc.Graph(
                ...
                figure={
                    ...
                    'layout': {
                        'title': 'Data sent for each application'
                    }
                }
            )
        ],
    ...
    dcc.Graph(
        ...
        figure={
            ...
            'layout': {
                'title': 'Sent vs Received data for applications with most clients'
            }
        }
    ),
    dcc.Graph(
        ...
        figure = { 'data': datas,
            'layout': {
                'title': 'Number of clients for top visited sites over time'
            }
